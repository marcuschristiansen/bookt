<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <div class="mt-8 text-2xl">Welcome to Bookt!</div>

            <div class="mt-6 text-gray-500">
                <jet-nav-link :href="route('bookings.create')"
                    >Make a new booking</jet-nav-link
                >
            </div>
        </div>
        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    >
                        <a href="https://laravel.com/docs">Your next booking</a>
                    </div>
                </div>

                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        <p>Your next booking is</p>
                        <!--                        <h1 class="text-2xl">{{ user.next_booking.date }}</h1>-->
                    </div>
