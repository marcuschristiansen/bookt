...
export default {
    ...
    computed: {
        ...
        // selectedCalendar() {
        //     const calendarId = this.$page['props']['filteredCalendar']
        ...
        //     }
        //
        //     return this.calendars.length && this.calendars
        //         ? this.calendars[0]
        //         : []
        // },
    },
    ...
    methods: {
        ...
        deleteBooking(id) {
            // confirm with user
            if (!confirm('Are you sure want to delete this booking?')) return
